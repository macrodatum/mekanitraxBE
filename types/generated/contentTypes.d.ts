...
export interface ApiClienteCliente extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    fechaCumpleanos: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::cliente.cliente'
...
export interface ApiServicioVehiculoServicioVehiculo
  ...
  attributes: {
    costo_repuestos: Schema.Attribute.BigInteger;
    costo_servicio: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descripcion: Schema.Attribute.Blocks;
    estado_servicio: Schema.Attribute.String;
    fecha_servicio: Schema.Attribute.Date;
    ...
    > &
      Schema.Attribute.Private;
    nombre_mecanico: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    tipo_servicio: Schema.Attribute.Text & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiVehiculoVehiculo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cilindraje: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descripcion: Schema.Attribute.Blocks;
    ...
    fotos: Schema.Attribute.Media<'images' | 'files', true>;
    kilometraje_actual: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    servicio_vehiculos: Schema.Attribute.Relation<
      'oneToMany',
      'api::servicio-vehiculo.servicio-vehiculo'
    >;
    tipo_combustible: Schema.Attribute.String;
    tipo_vehiculo: Schema.Attribute.String;
